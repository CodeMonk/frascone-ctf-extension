...
open: function()
      {
        if(!CTerminal.isOpen){
          ...
          jQuery(document.body).append(
              "<div id='"+CTUtils.ROOT+"'><div id='form'><form><input type='text' maxlength='36'/></form></div><div id='preview'></div></div>");
          // to open
...
enter: function(command, input, preview, terminal)
       {
         preview.preview('Press Ctrl+space to open or close the terminal.');
       }
